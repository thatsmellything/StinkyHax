...
=========================
sessions -i (number for sesion) = Choose which session you wish to interact with
background                      = Send current session to te background. Brings you back to msf> state
